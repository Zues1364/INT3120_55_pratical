...
class BusScheduleViewModel(private val scheduleDao: ScheduleDao) : ViewModel() {
    ...
    fun getFullSchedule(): Flow<List<BusSchedule>> = scheduleDao.getAllItems()
    ...
    companion object {
        val factory : ViewModelProvider.Factory = viewModelFactory {
            initializer {
                val application = (this[AndroidViewModelFactory.APPLICATION_KEY] as BusScheduleApplication)
